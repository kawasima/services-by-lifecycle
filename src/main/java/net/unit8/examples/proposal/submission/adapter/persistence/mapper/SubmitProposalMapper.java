...
import net.unit8.examples.proposal.adapter.persistence.entity.ProposalJpaEntity;
import net.unit8.examples.proposal.adapter.persistence.entity.ProposalStatus;
...
@Component
public class SubmitProposalMapper {
